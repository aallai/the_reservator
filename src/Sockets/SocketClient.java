...
public class SocketClient implements ResInterface.Callback {
    ...
    public static void main(String args[])
	{
	    ...
	    if (args.length != 2) 
		{
			System.out.println ("Usage: java client port middlewarehost:port"); 
			System.exit(1); 
	    }
	    
	    int port = Integer.parseInt(args[0]);
	    Address rm = new Address(args[1].split(":")[0], Integer.parseInt(args[1].split(":")[1]));
		
		final SocketClient client = new SocketClient(rm, port);
		...
		case 2:  //new flight
			...
			if (((Boolean) client.request("addFlight", Id, flightNum, flightSeats, flightPrice)).booleanValue()) {
		...
		case 3:  //new Car
			...
			if ( ((Boolean) client.request("addCars", Id, location, numCars, price)).booleanValue() )
		...
		case 4:  //new Room
			...
			price = client.getInt(arguments.elementAt(4));
			if (( (Boolean) client.request("addRooms", Id, location, numRooms, price)).booleanValue() )
		...
		case 5:  //new Customer
			...
			int customer = (Integer) client.request("newCustomer", Id);
		...
		case 6: //delete Flight
			...
			if ( ((Boolean) client.request("deleteFlight", Id, flightNum)).booleanValue() )
		...
		case 7: //delete Car
			...
			if ( ((Boolean) client.request("deleteCars", Id, location)).booleanValue() )
		...
		case 8: //delete Room
			...
			if ( ((Boolean) client.request("deleteRooms", Id, location)).booleanValue() )
		...
		case 9: //delete Customer
			...
			if ( ((Boolean) client.request("deleteCustomer", Id, customer)).booleanValue() )
		...
		case 10: //querying a flight
			...
			int seats = (Integer) client.request("queryFlight", Id, flightNum);
		...
		case 11: //querying a Car Location
			...
			numCars = (Integer) client.request("queryCars", Id, location);
		...
		case 12: //querying a Room location
			...
			numRooms = (Integer) client.request("queryRooms", Id, location);
		...
		case 13: //querying Customer Information
			...
			String bill = (String) client.request("queryCustomerInfo", Id, customer);
		...
		case 14: //querying a flight Price
			...
			price = (Integer) client.request("queryFlightPrice", Id, flightNum);
		...
		case 15: //querying a Car Price
			...
			price = (Integer) client.request("queryCarsPrice", Id, location);
		...
		case 16: //querying a Room price
			...
			price = (Integer) client.request("queryRoomsPrice", Id, location);
		...
		case 18:  //reserve a car
			...
			if ( ((Boolean) client.request("reserveCar", Id, customer, location)).booleanValue() )
		...
		case 19:  //reserve a room
			...
			if ( ((Boolean) client.request("reserveRoom", Id, customer, location)).booleanValue() )
		...
		case 20:  //reserve an Itinerary
			...
			if ( ((Boolean) client.request("itinerary", Id, customer, flightNumbers, location, Car, Room)).booleanValue() )
		...
		case 22:  //new Customer given id
			...
			boolean customer = (Boolean) client.request("newCustomer", Id, Cid);
    ...
    public SocketClient(Address rm, int port)
    {
    	this.rm = rm;
    ...
    /**
     * Send a request to the rm
     * @param args
     * @return
     */
    private Serializable request(String type, Serializable... args)
    {
    	...
    	int id = get_id();
    	Message m = new Message(this.rm, this.self, this.self, id, type, data);
    ...
    public void result(Integer id, Serializable obj)
	{
	...
	{
		System.err.println("Error recived from " + from.toString() + 
								" for request " + id );
		System.err.println("---");
